    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Tòa 21A Tố hữu <br />Cầu giấy, Hà Nội, Việt Nam</p>
          <p className='text-gray-500'>Tel: (+84) 312324395 <br /> Email: trantuyenquang001@gmail.com</p>
